...
async function getSellerNotifications(sellerId) {
  const query = "SELECT * FROM seller_notifications WHERE seller_id = $1";
...
const setAllSellerNotificationTrueService = async (userId) => {
  const query = `
...
module.exports = {
  ...
  setAllSellerNotificationTrueService,
};
